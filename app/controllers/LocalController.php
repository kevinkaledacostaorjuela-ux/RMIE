...
class LocalController {
    ...
    public function delete() {
        ...
        if ($_SESSION['rol'] === 'coordinador') {
            echo '<script>alert("El rol de coordinador no tiene permisos para eliminar registros por políticas de seguridad."); window.location.href = "/RMIE/app/controllers/LocalController.php?accion=index";</script>';
            exit();
        }
