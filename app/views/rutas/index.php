                        ...
                        <div class="widget-content">
                            <div class="activity-list">
                                <div class="activity-item">
                                    ...
                                    <span class="activity-text">Ruta #<?= $totalRutas + 1 ?> creada</span>
                                </div>
                                <div class="activity-item">
                                    <span class="activity-time">Hace 15 min</span>
                                    <span class="activity-text">Optimización completada</span>
                                </div>
                                <div class="activity-item">
                                    <span class="activity-time">Hace 1 hora</span>
                                    <span class="activity-text">Reporte generado</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-content">
                            <div class="performance-metrics">
                                ...
                                <div class="metric-item">
                                    ...
                                    <div class="metric-bar">
                                        <div class="metric-progress" style="width: <?= $totalRutas > 0 ? ($rutasCompletadas * 100 / $totalRutas) : 0 ?>%"></div>
                                    </div>
                                    <span class="metric-value"><?= $totalRutas > 0 ? round($rutasCompletadas * 100 / $totalRutas) : 0 ?>%</span>
                                </div>
                                <div class="metric-item">
