                ...
                <div class="row mb-4">
                    <div class="col-12 d-flex justify-content-center">
                        <input type="text" 
                               ...
                               style="border: none; font-size: 18px; padding: 15px 25px; height: 55px; background: white; color: #333; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 600px;">
                    </div>
                </div>
